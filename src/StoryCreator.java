...
public class StoryCreator {
    ...
    public static void main(String[] args) {
        ...
        sc.choose(1,sc.prob.aBoolean(50),4);
    ...
    private void default_scene(){
        ...
        for (int i=0;i<length;i++) {
            if (prob.aBoolean(60)) {
                ...
                else story.add(sentence.makeSentence("sub:我:chara"));
            }
            else expand(2);
        }
    }
    private void special_scene(){
        ...
        for (int i=0;i<length;i++){
            ...
            from=to;to=to+40;
            if(from<=probability&&probability<to)if(has_charactor)main=sentence.makeCharaSentence(chara,env,chara_list);
            from=to;to=to+40;
